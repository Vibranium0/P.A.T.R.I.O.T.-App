...
cd "$SCRIPT_DIR"
source "$SCRIPT_DIR/patriot/backend/venv/bin/activate"
PYTHONPATH="$SCRIPT_DIR" nohup python "$SCRIPT_DIR/patriot/backend/app.py" > "$SCRIPT_DIR/patriot_backend.log" 2>&1 &
deactivate
...
cd "$SCRIPT_DIR"
source "$SCRIPT_DIR/sentinel_login/backend/venv/bin/activate"
PYTHONPATH="$SCRIPT_DIR" nohup python "$SCRIPT_DIR/sentinel_login/backend/app.py" > "$SCRIPT_DIR/sentinel_backend.log" 2>&1 &
deactivate
